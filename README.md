...
# Core install
./env_create_uv.sh
# Or include demo dependencies (jupyter, jupyterlab, matplotlib, scipy)
./env_create_uv.sh --demo
```

This script creates a `.venv`, installs the package (with optional demo extras),
and registers a Jupyter kernel named `DeLASE`.
